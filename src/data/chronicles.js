  ...
  'black-ledger': {
    ...
    chapters: [
      ...
      },
      {
        num: 24,
        title: 'Black Import',
        file: '/chronicles/black-ledger/chapter-24.html',
        pov: 'Unknown',
        status: 'published',
      },
      {
        num: 25,
        title: 'Velvet Front',
        file: '/chronicles/black-ledger/chapter-25.html',
        pov: 'Unknown',
        status: 'published',
      },
      {
        num: 26,
        title: 'Shadow War',
        file: '/chronicles/black-ledger/chapter-26.html',
        pov: 'Unknown',
        status: 'published',
      },
      {
        num: 27,
        title: 'Margin Call',
        file: '/chronicles/black-ledger/chapter-27.html',
        pov: 'Unknown',
        status: 'published',
      },
    ],
